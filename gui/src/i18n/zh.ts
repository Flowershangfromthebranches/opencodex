...
"common.discard": "丢弃",
  ...
  "models.nativeContextModeDefault": "默认",
  "models.nativeContextModeOneMillion": "1M",
  "models.nativeContextModeDefaultHint": "使用 Codex 官方推荐的默认上下文配置。",
  "models.nativeContextModeOneMillionHint": "为原生 GPT-5.6 Sol、Terra 和 Luna 启用 Codex 1M 上下文模式。",
  "models.nativeContextModeExperimental": "实际最大可用上下文取决于账户与 OpenAI 后端 rollout。若超长请求被拒绝，请切回默认。新会话会使用同步后的设置；如提示 app-server 已过期，请重启 Codex。",
  "models.nativeContextModeApplied": "GPT-5.6 上下文模式已同步，新 Codex 会话将使用该设置。",
  "models.nativeContextModeSaveFailed": "无法应用 GPT-5.6 上下文模式；已恢复此前设置。",
